  ...
  <div class="articleEdit">
    <div class="articleMain">
      <div class="box-card">
        ...
        <div class="card-left" :style="{backgroundImage: 'url('+item.image+')', backgroundSize: 'cover'}" v-if="item.image">
          <el-button icon="el-icon-delete" circle class="imgDel" @click="item.image = null"></el-button>
        </div>
